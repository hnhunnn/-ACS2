  ...
  <div class="form-container" style="max-width: 500px; margin: 0 auto;">
    ...
    <form method="POST" action="/movies/update" enctype="multipart/form-data">
      ...
      <div class="mb-2">
        ...
        <input type="file" class="form-control" id="movieImage" name="movie_image" accept="image/*">
      </div>
      ...
      <div class="d-flex justify-content-between">
        <button type="button" class="btn btn-secondary"><a href="{{ route('admin.listMovie') }}" class="text-white">Trở lại</a></button>
